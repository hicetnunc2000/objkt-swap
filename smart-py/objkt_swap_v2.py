class Marketplace(sp.Contract):
    ...
    def swap(self, params):
        ...
        self.data.swaps[self.data.counter] = sp.record(issuer=sp.sender, fa2=params.fa2, objkt_amount=params.objkt_amount, objkt_id=params.objkt_id, xtz_per_objkt=params.xtz_per_objkt, royalties=params.royalties, creator=params.creator)
        self.data.counter += 1
    ...
    def collect(self, params):
        ...
        self.fa2_transfer(self.data.swaps[params.swap_id].fa2, sp.self_address, sp.sender, self.data.swaps[params.swap_id].objkt_id, 1)
    
    @sp.entry_point
    def cancel_swap(self, params):
        sp.verify((sp.sender == self.data.swaps[params].issuer) & (self.data.swaps[params].objkt_amount != 0))
        self.fa2_transfer(self.data.swaps[params].fa2, sp.self_address, sp.sender, self.data.swaps[params].objkt_id, self.data.swaps[params].objkt_amount)
